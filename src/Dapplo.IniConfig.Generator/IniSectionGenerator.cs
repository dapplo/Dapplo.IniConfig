...
namespace Dapplo.IniConfig.Generator;
...
{
    private const string IniSectionAttributeFqn = "Dapplo.IniConfig.Attributes.IniSectionAttribute";
    private const string IniValueAttributeFqn   = "Dapplo.IniConfig.Attributes.IniValueAttribute";

    // FQNs used for non-generic (dispatch) lifecycle interfaces
    private const string IAfterLoadFqn        = "Dapplo.IniConfig.Interfaces.IAfterLoad";
    ...
    private static string Emit(SectionModel m)
    {
        ...
        sb.AppendLine("using Dapplo.IniConfig.Configuration;");
        sb.AppendLine("using Dapplo.IniConfig.Converters;");
        sb.AppendLine();
        ...
        if (m.ImplementsBeforeSaveGeneric)
            extraBases.Add("Dapplo.IniConfig.Interfaces.IBeforeSave");
        if (m.ImplementsAfterSaveGeneric)
            extraBases.Add("Dapplo.IniConfig.Interfaces.IAfterSave");

        string baseClasses = "Dapplo.IniConfig.Configuration.IniSectionBase, " + m.InterfaceName;
        ...
        if (m.ImplementsAfterLoadGeneric)
        {
            sb.AppendLine("        void Dapplo.IniConfig.Interfaces.IAfterLoad.OnAfterLoad()");
        ...
        if (m.ImplementsBeforeSaveGeneric)
        {
            sb.AppendLine("        bool Dapplo.IniConfig.Interfaces.IBeforeSave.OnBeforeSave()");
